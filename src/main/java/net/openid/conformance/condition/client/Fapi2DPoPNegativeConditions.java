...
public class Fapi2DPoPNegativeConditions {
	...
	static abstract class ChangeDpopHeader extends AbstractCondition {
	...
	//=====================================
	static abstract class ChangeDpopClaims extends AbstractCondition {
	...
	public static class DpopHtuUpperCase extends ChangeDpopClaims {
		...
		public void changeClaim(JsonObject claims, Environment env) {
			...
			claims.addProperty("htu", resourceEndpoint.toUpperCase());
	...
	//=====================================
	// Conditions specific to DPoP that are specific
	//=====================================
